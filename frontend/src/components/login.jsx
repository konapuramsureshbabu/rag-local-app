  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (VALID_USERNAME && VALID_PASSWORD) {
        ...
        // Original API-based authentication as fallback
      ...
      >
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            >
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg mx-auto "><span className='font-bold text-indigo-600'>RAG
                </span>
            ...
            <div className="mb-6">
              ...
              <motion.div whileFocus={{ scale: 1.01 }}>
                <input
                  ...
                  placeholder={VALID_USERNAME ? 'Enter username' : 'your@email.com'}
                  required
                />
              </motion.div>
            </div>
